    ...
    <div class="col-lg-10 mt-5">
      <div class="table-responsive">
        ...
        <tr>
          ...
          <td><?= $dt_bar->gambar ?></td>
          <td> <a href="#update" onclick="tm_detail('<?= $dt_bar->id_pakaian ?>')" data-toggle="modal">Ubah</a> |
             <a href="<?=base_url('index.php/pakaian/hapus_pakaian/'.$dt_bar->id_pakaian)?>" onclick="return confirm('Apakah Anda Yakin?')">Hapus</a></td>
        </tr>
      <?php endforeach ?>
          </tbody>
        </table>
